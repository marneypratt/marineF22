...
To get your data ready to graph, you will need to do some calculations and other "wrangling" to get it in shape. You can do this in Excel or Google Sheets and then upload just the ready to graph dataset. 
